                ...
                <div className="modal-dialog modal-xl">
                  <div className="modal-content border-0">
                    ...
                    <div className="modal-body">
                      {
                        modalType === "delete" ? (
                          <p className="text-danger">是否要刪除 <strong>{tempData.title}</strong> 產品？</p>
                        ) : (
                        <div className="row">
                          <div className="col-sm-4">
                            <div className="mb-2">
                              <div className="mb-3">
                                ...
                                <input type="file" className="form-control" name="fileUpload" id="fileUpload" accept=".jpg,.jpeg,.png"  onChange={(e)=>uploadImaage(e)}/>
                                </div>
                              <div className="mb-3">
                            ...
                            <div>
                              ...
                              {
                                tempData.imagesUrl.length < 5 && tempData.imagesUrl[tempData.imagesUrl.length - 1] !== "" && (
                          ...
                          <div className="col-sm-8">
                            ...
                            <div className="mb-3">
                             ...
                             <div className="mb-3">
                              <label htmlFor="content" className="form-label">尺寸</label>
                              <textarea
                                name="size"
                                id="size"
                                className="form-control"
